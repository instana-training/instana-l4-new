...
![Lab 4](images/14.1.png) 

Use Simple tab for Helm command

![Lab 4](images/14.2.png) 
...
![Lab 4](images/14.4.png) 

Then, click the Add Synthetic Test button.
![Lab 4](images/14.5.png) 
